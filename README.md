...
- ### Linked Lists
    ...
    - [X] [why you should avoid linked lists (video)](https://www.youtube.com/watch?v=YQs6IC-vgmo)
            -Take up more memory than an array (now you need to store pointers in addition to the actual elements)
            -Insertion or deletion at nodes in the middle can really hurt with large lists, cuz we first must iteration to the deletion or 
            insertion point: we maximize our cache misses with this! Performance ends up being hurt really bad by this 
